unit ripscr;
// ====================================================================
// RETIRED — This engine is no longer maintained.
// Preserved in attic/ with all fixes applied (2026-08-19).
// Superseded by m_rip.pas in mdl/ (one engine, plugin codecs).
// Version: 1.0.1-irc — RIPscrip v1.54
// See docs/MYSTIC-RIP-MIGRATION.md for migration plan.
// ====================================================================
...
{ Draw pixel using current fill pattern. Draws BG for pattern gaps.
  Backport from ripviewer PutFillPixel. }
Var PatRow: Byte;
Begin
  If Not InView(X, Y) Then Exit;
