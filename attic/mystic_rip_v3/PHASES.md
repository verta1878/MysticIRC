...
- [x] DEFERRED TO v4: Full Unicode (UTF-8 pass-through for RFF fonts with wider char ranges)
...
- [x] MIDI playback — MIDILoad/MIDIFree + midisynth.pas (FM synthesis, 16 channels)
