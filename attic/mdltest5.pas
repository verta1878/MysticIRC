...
// --------------------------------------------------------------------
// Standalone test program for the legacy TSocketClass
// (mdl/m_socket_class.pas), which is retired alongside it.  Neither is
// used by the live code (A51 uses TIOSocket in m_io_sockets.pas).
// Retired from mdl/ on 2026-07-06 (fork).  Kept for GPL-3 attribution
// and scene history.
// ====================================================================
