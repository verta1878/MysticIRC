...
Begin
  ...
  Form.AddBol  ('R', ' Allow Foreign',    31, 15, 47, 15, 14, 3, @bbsCfg.inetSMTPAllowForeign, Topic + 'Accept mail to foreign domains for unknown users (off = A38 refuse)');
...
//  Form.AddStr  ('2', ' Default Domain',       11, 18, 29, 18, 16,  8,  8, @bbsCfg.DefDomain, Topic + 'Default echomail domain');
  ...
  Form.AddTog  ('T', ' Create Semaphore',     47, 15, 67, 15, 18, 7, 0, 1, 'Logout MsgPost', @bbsCfg.CreateSemaphore, Topic + 'Create .out files when?');
