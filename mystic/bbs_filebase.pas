...
Begin
  ...
  If ErrCode <> 0 Then Begin
    ErrorLog('ERROR: Can''t find xfer.log, error ' + strI2S(ErrCode));
    Exit;
  End;
...
Begin
  ...
  // A61: @TEXTDIZ â€” if the archive config for this file extension has
...
Begin
  ...
  // A61: @TEXTVIEW â€” display using ANSI viewer with SAUCE extraction
  ...
  // A61: @TEXTSHOW â€” display using standard display function
...
Begin
  ...
  While Not Eof(ArcFile) Do Begin
    ...
    If Arc.Active and ((Arc.OSType = OSType) or (Arc.OSType = 3)) Then Begin
      // A61: skip archives with @ prefix in description â€” these are
