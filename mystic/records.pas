...
Const
  ...
  fn_SemFileMisBusy = 'mis.bsy';                                 // A38 fork: MIS running-lock (from 1.12)
...
Type
 ...
 // ECHOMAIL NETWORKS
    ...
    Res1            : Array[1..209] of Byte;  // A38 fork: 210->209, 1 byte -> inetSMTPRefuseForeign
 ...
 // INTERNET SERVER SETTINGS
    ...
    inetSMTPAllowForeign  : Boolean;  // A38 fork: allow mail to foreign domains for unknown users.  FALSE (default/zeroed) = refuse = original A38 behavior; TRUE = accept.
    inetPOP3Use     : Boolean;
    inetPOP3Port    : Word;
    inetPOP3Max     : Word;
    inetPOP3Dupes   : Byte;
 ...
 // UNSORTED
  ...
  //  DefDomain       : String[8];
    ...
    inetFTPHideQWK    : Boolean;                  // A40+: officially a Byte (0/1/2); kept Boolean here
    AcsMsgUpload      : String[mysMaxAcsSize];
    CreateSemaphore   : Byte;
...
Type
  ...
  RecPercent = Record
    ...
    HiChar    : Char;
    HiAttr    : Byte;
    Format    : Byte;                                           // 0=Horizontal 1=Vertical (set in Config -> Themes -> a theme -> 3:Percent Bars -> F:Bar Format)
    StartY    : Byte;
    Active    : Boolean;
    StartX    : Byte;
    LastPos   : Byte;
...
Type
  RecTheme = Record
    ...
    ColumnSize   : Byte;
    // A39: message-box theme fields (carved from Reserved 198->188; SizeOf
    // unchanged, on-disk compatible).  Used by ThemeMessageBox/TAnsiListBox.
    BoxFrame      : Byte;
    BoxAttr       : Byte;
    BoxAttr2      : Byte;
    BoxAttr3      : Byte;
